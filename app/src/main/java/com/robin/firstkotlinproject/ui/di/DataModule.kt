...
import com.robin.firstkotlinproject.data.lastfm.interceptor.LastFmRequestInterceptor
import com.robin.firstkotlinproject.ui.di.qualifier.ApiKey
import com.robin.firstkotlinproject.ui.di.qualifier.ApplicationQualifier
import com.robin.firstkotlinproject.ui.di.qualifier.CacheDuration
...
class DataModule {
    ...
    @Provides
    @Singleton
    fun provideCache(@ApplicationQualifier context: Context): Cache = Cache(context.cacheDir, 10 * 1024 * 1024.toLong())
    ...
    @Singleton
    @CacheDuration
    fun provideCacheDuration(@ApplicationQualifier context: Context): Int = 86400
    ...
    @Provides
    @Singleton
    fun provideRequestInterceptor(@ApiKey apiKey: String, @CacheDuration cacheDuration: Int): LastFmRequestInterceptor
